...
class VenueDetailsBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        AppSizes.kHeight20,
        _vendorDetails(venueData, context),
        AppSizes.kHeight20,
  ...
  Row _vendorDetails(Response venueData, BuildContext context) {
    return Row(
          ...
          children: [
            Row(
              children: [
                ...
                Text(venueData.vmId!.name!, style: AppTextStyles.textH4),
              ],
            ),
            AppSizes.kHeight10,
            Row(
  ...
  Column _venueSlotsWidget(Response venueData) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Column _venueDiscription(Response venueData) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Row _venuePlace(Response venueData) {
    return Row(
  ...
  Row _venueInfoWidget(Response venueData) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Container _venueImageContainer(Size size, Response venueData) {
    return Container(
